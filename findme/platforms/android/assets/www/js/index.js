...
var app = {
  ...
  onDeviceReady: function() {
    ...
    var Camera = window.Camera = navigator.camera;
  ...
  stopScan : function(){
    setTimeout(function(){
      ...
      $(".search").css({
        ...
        $(".searchRotate").children('span').html(app.getLength(BC.bluetooth.devices) + " device found");
      });
    },5*1000);
  },

  getLength:function(args){
  ...
  farAwayFunc: function() {
    ...
    if (app.safetyAlarmIsOpen && !app.isAlert) {
      app.isAlert = true;
